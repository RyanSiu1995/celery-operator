...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CeleryBrokerType) DeepCopyInto(out *CeleryBrokerType) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CeleryBrokerType.
func (in *CeleryBrokerType) DeepCopy() *CeleryBrokerType {
	if in == nil {
		return nil
	}
	out := new(CeleryBrokerType)
	in.DeepCopyInto(out)
	return out
}
